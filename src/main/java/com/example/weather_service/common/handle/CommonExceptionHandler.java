package com.example.weather_service.common.handle;


import com.example.weather_service.common.exception.CityNameNotFoundException;
...
public class CommonExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    ApiResponse cityNotFound(Exception e) {
        return new ApiResponse(
                e.getMessage(),
                null
        );
